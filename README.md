...
✔ Generate fake sales entries  
✔ Add a new sale  
✔ List all sales with indexes  
✔ Update a field of a sale record  
✔ Delete a sale by index  
✔ Search records by specific field  
✔ Simple CLI menu (switch/case)
